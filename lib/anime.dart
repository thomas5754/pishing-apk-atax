...
const Color kPrimaryColor = Color(0xFFE0E0E0); // Glowing Silver
const Color kBackgroundColor = Color(0xFF050505); // Deep Black
const Color kCardColor = Color(0xFF1A1A1A); // Dark Grey for Cards
const Color kHighlightColor = Color(0xFF252525); // For Shimmer/Placeholders
...
class _HomeAnimePageState extends State<HomeAnimePage> {
      ...
      appBar: AppBar(
        ...
        title: const Text(
          ...
          style: TextStyle(
            ...
            color: kPrimaryColor,
            shadows: [Shadow(color: kPrimaryColor, blurRadius: 4)],
          ),
        ),
        actions: [
          IconButton(
      ...
      children: [
        ...
        Text(
          ...
          style: const TextStyle(
            ...
            fontWeight: FontWeight.bold,
            color: kPrimaryColor,
            shadows: [Shadow(color: kPrimaryColor, blurRadius: 2)],
          ),
        ),
      ],
    );
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => AnimeEpisodePage(
                  ...
                  onHistoryUpdate:
                      refreshHistory, // Pass callback to update history
                ),
              ),
            ).then((_) => refreshHistory());
          } else {
                        ...
                        if (score != null && score.isNotEmpty) ...[
                          Row(
                            children: [
                              const Icon(
                                Icons.star,
                                color: kPrimaryColor, // Silver star
                                size: 16,
                              ),
  ...
  Color _getStatusColor(String status) {
    switch (status.toLowerCase()) {
      case 'ongoing':
        return Colors.white; // White for ongoing
      case 'completed':
        return kPrimaryColor; // Silver for completed
      default:
        return Colors.grey;
    }
  }
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => AnimeEpisodePage(
                            ...
                            onHistoryUpdate: widget
                                .onHistoryUpdate, // Pass callback to update history
                          ),
                        ),
                      ).then((_) {
      ...
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder: (context) => AnimeEpisodePage(
            ...
            onHistoryUpdate:
                widget.onHistoryUpdate, // Pass callback to update history
          ),
        ),
      );
    }
        ...
        child: InkWell(
          ...
          child: Column(
            ...
            children: [
              Icon(
                icon,
                color: isSelected ? Colors.black : kPrimaryColor,
                size: 20,
              ),
              const SizedBox(height: 4),
              Text(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  color: isCurrentEpisode ? kPrimaryColor : kCardColor,
                  borderRadius: BorderRadius.circular(8),
                ...
                child: ListTile(
                  ...
                  trailing: Icon(
                    ...
                    color: isCurrentEpisode ? Colors.black : kPrimaryColor,
                  ),
                ),
              );
            },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (recommendation['score'] != null &&
                          recommendation['score'].toString().isNotEmpty)
                        Row(
                          children: [
                            const Icon(Icons.star,
